...
Usage
	...
	$video = Mpfy_Carbon_Video::create($youtube_link);
 ...
 */
abstract class Mpfy_Carbon_Video {
	/**
	...
	/**
	 * Caching object
	 * @var Mpfy_Carbon_Video_Cache
	 */
	public $cache;

	/**
	 * Http-related object
	 * @var Mpfy_Carbon_Video_Http
	 */
	public $http;
	 ...
	 * @return object Mpfy_Carbon_Video
	 **/
	static function create($video_code) {
		...
		foreach ($video_providers as $video_provider) {
			$class_name = "Mpfy_Carbon_Video_$video_provider";
		...
		if (is_null($video)) {
			...
			$video = new Mpfy_Carbon_Video_Broken();
		}
	...
	function __construct() {
		$this->cache = new Mpfy_Carbon_Video_Cache();
		$this->http = new Mpfy_Carbon_Video_Http();
	}
 ...
 * Vimeo handling code
 */
class Mpfy_Carbon_Video_Vimeo extends Mpfy_Carbon_Video {
 ...
 */
class Mpfy_Carbon_Video_Youtube extends Mpfy_Carbon_Video {
 ...
 */
class Mpfy_Carbon_Video_Broken extends Mpfy_Carbon_Video {
